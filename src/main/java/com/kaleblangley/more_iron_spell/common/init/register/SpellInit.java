...
import com.kaleblangley.more_iron_spell.common.spell.LightningBomb;
...
public class SpellInit {
    ...
    public static RegistryObject<AbstractSpell> LIGHTNING_BOMB = SPELL.register("lightning_bomb", LightningBomb::new);
