...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<LightningBombEntity>> LIGHTNING_BOMB = TYPE.register("lightning_bomb", () -> EntityType.Builder.of(LightningBombEntity::new, MobCategory.MISC).fireImmune().build("lightning_bomb"));
}
